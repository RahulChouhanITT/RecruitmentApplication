import type { ApplicationStatus, InterviewsViewFilter, JobsStatusFilter, MyApplicationsStatusFilter } from "../types/jobTypes";
...
export const MY_APPLICATIONS_FILTER_OPTIONS: Array<{ value: MyApplicationsStatusFilter; label: string }> = [
...
export const JOBS_VALIDATION_MESSAGES = {
  ...
  REQUIRED_SKILLS_MAX_LENGTH: (count: number) => `Required skills cannot exceed ${count} characters`,
...
export const JOBS_PANEL_TEXT = {
  ...
  STATUS_CONFIRMATION: (status: string) => `Are you sure you want to update the candidate status to ${status}?`,
  JOB_STATUS_CONFIRMATION: (action: string) => `Are you sure you want to ${action.toLowerCase()} this job?`,
