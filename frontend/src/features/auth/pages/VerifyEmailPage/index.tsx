...
export const VerifyEmailPage = () => {
  ...
  return (
    <PageContent>
      <AuthLayout
        title={AUTH_UI_TEXT.VERIFY_EMAIL_TITLE}
        subtitle={AUTH_UI_TEXT.VERIFY_EMAIL_SUBTITLE}
      >
        ...
        <Form onSubmit={onVerifyEmail} noValidate>
          ...
          <ResendRow>
            <ResendButton type="button" onClick={onResendOtp} disabled={isResendLoading}>
        ...
        <BottomMessage>
          Back to{' '}
          <BackLink to={AUTH_ROUTE_PATHS.REGISTER}>{AUTH_UI_TEXT.VERIFY_EMAIL_BACK_TEXT}</BackLink>
        </BottomMessage>
      </AuthLayout>
    </PageContent>
  );
